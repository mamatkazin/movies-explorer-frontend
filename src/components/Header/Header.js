    ...
    <header className="header">
      <div className="header__content page__content">
        <img className="logo header__logo" src={logo} alt="Логотип дипломного проекта" />
        {
          ...
          <>
            <div
              className={menuOpened ? "header__variable header__variable_opened" : "header__variable"}
            >
              {props.children}
            </div>
            <div className="header__appbar">
              ...
              <button
                className={
                  menuOpened ? "button button-close header__menu" : "button button-menu header__menu"
                }
